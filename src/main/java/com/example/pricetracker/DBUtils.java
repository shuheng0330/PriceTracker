...
public class DBUtils {
        ...
        public static void signUpUser(ActionEvent event, String username, String password, String email, int contactno,String confirmpassword) {
            ...
            try {
                ...
                if (resultSet.isBeforeFirst()) { //To check the resultSet is empty or not.If true,the username has already taken.
                    ...
                    psInsert = connection.prepareStatement("INSERT INTO users(username,password,email,contactno,confirmpassword) VALUES(?,?,?,?,?)");
                    psInsert.setString(1, username);
                    psInsert.setString(2, password);
                    psInsert.setString(3,email );
                    psInsert.setInt(4, contactno);
                    psInsert.setString(5,confirmpassword );
